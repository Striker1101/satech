...
!(function (t, e) {
    ...
    const Ke = (t, e) =>
        !0 === t ? e : "string" == typeof t ? v(e, t) : void 0;
    ...
    function fs(t, e, i) {
        const s = t.canvas,
            n = new MutationObserver((t) => {
                let e = !1;
                for (const i of t)
                    (e = e || us(i.addedNodes, s)),
                        (e = e && !us(i.removedNodes, s));
                e && i();
            });
    ...
    function _s(t, e, i) {
        i && i.disconnect(),
            "resize" === e &&
                (function (t) {
                    ps.delete(t),
                        ps.size || window.removeEventListener("resize", bs);
                })(t);
    }
    function ys(t, e, i) {
        const s = t.canvas,
    ...
    class Bs {
        ...
        applyStack(t, e, i) {
            const s = this.chart,
                ...
                o = e[t.axis];
            return As(
                { keys: Os(s, !0), values: e._stacks[t.axis] },
                o,
                n.index,
                { mode: i }
            );
        ...
        getMinMax(t, e) {
            const i = this._cachedMeta,
                ...
                l = ((t, e, i) =>
                    t &&
                    !e.hidden &&
                    e._stacked && { keys: Os(i, !0), values: null })(
                    e,
                    i,
                    this.chart
                ),
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                f.$shared &&
                    ((f.$shared = r), (n[o] = Object.freeze(Vs(f, r)))),
                f
            );
        }
    ...
    class Zn extends Ns {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = Ii(this, this.options.segment))
            );
        }
        first() {
    ...
    var Eo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (l = n[a]),
                    l && !1 !== l.fill && (l.fill = Mo(n, a, i.propagate));
        },
        beforeDraw(t, e, i) {
                ...
                l.setWidth(this.width),
                    b
                        ? v > 0 &&
                          ...
                          f.line++,
                          (S = f.x =
                              ut(n, this.left + c, this.right - i[f.line])))
                        : v > 0 &&
                          P + _ > this.bottom &&
    ...
    class ea extends Ns {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = jo(a, $o(s))), (a = jo(a, $o(n))), (a = jo(a, $o(o))), a
            );
        }
        getBeforeBody(t, e) {
            ...
            const n = (function (t, e) {
                ...
                for (
                    ...
                    (u && M !== a
                        ? (s.push({ value: a }),
                          M < a && D++,
                          F(Math.round((M + D * S) * v) / v, a, aa(a, y, t)) &&
                              D++)
                        : M < a && D++);
                    D < k;
                    ++D
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = Sa.indexOf(t) + 1, i = Sa.length;
                                  e < i;
                                  ++e
                              )
        ...
        Ra = Object.freeze({
            ...
            CategoryScale: class extends Ks {
                ...
                parse(t, e) {
                    ...
                    const s = this.getLabels();
                    return ((t, e) =>
                        null === t ? null : Z(Math.round(t), 0, e))(
                        (e =
                            isFinite(e) && s[e] === t
                                ? e
