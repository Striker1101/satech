        ...
        return this.each(function () {
            ...
            var i = n.extend({}, n.fn.marquee.defaults, t),
                ...
                w = {
                    ...
                    resume: function () {
                        a && i.allowCss3Support
                            ? u.css(nt, "running")
                            : n.fn.resume && u.resume();
                        r.data("runningStatus", "resumed");
                        r.trigger("resumed");
                    },
                    toggle: function () {
                        w[
                            "resumed" == r.data("runningStatus")
                                ? "pause"
                                : "resume"
                        ]();
                    },
            ...
            if ("string" == typeof t)
                ...
                if (
                    (n.each(i, function (n) {
                        if (
                            ((b = r.attr("data-" + n)), "undefined" != typeof b)
                        ) {
                            switch (b) {
                                case "true":
                                    b = !0;
                ...
                d = function () {
                    if (
                        (i.duplicated &&
                            (1 === f
                                ? ((i._originalDuration = i.duration),
                                  (i.duration = k
                                      ? "up" == i.direction
                                          ? i.duration + o / (l / i.duration)
                                          : 2 * i.duration
                                      : "left" == i.direction
                                      ? i.duration + c / (h / i.duration)
                                      : 2 * i.duration),
                                  e &&
                                      (e =
                                          s +
                                  ...
                                  f++)
                                : 2 === f &&
                                  ((i.duration = i._originalDuration),
                                  e &&
                                      ((s += "0"),
                                      (y = n.trim(y) + "0 "),
                                      (e =
                            ...
                            ? i.duplicated
                                ...
                                ? 2 === f
                                    ? (e &&
                                      ...
                                      f++)
                                    : 3 === f &&
                                      ((i.duration = i._completeDuration),
                                      e &&
                                          ((s += "0"),
                                          (y = n.trim(y) + "0 "),
                                          (e =
                        ...
                        var t = y + " { 100%  " + et(p) + "}",
                            v = u.find("style");
                        0 !== v.length
                            ? v.filter(":last").html(t)
                            : n("head").append("<style>" + t + "</style>");
                        ...
                        u.animate(p, i.duration, i.easing, function () {
                            r.trigger("finished");
                            i.pauseOnCycle
                                ? (r.timer = setTimeout(d, i.delayBeforeStart))
                                : d();
                        });
                    r.data("runningStatus", "resumed");
                };
                ...
                i.pauseOnHover &&
                    (r.bind("mouseenter", w.pause),
                    r.bind("mouseleave", w.resume));
                a && i.allowCss3Support
                    ? d()
                    : (r.timer = setTimeout(d, i.delayBeforeStart));
            }
