...
(function ($) {
    ...
    function givenDate($this, opts, type) {
        ...
        var seconds =
            (Math.floor(
                ((endDate - startDate) % (24 * 60 * 60 * 1000)) / 1000
            ) %
                60) %
            60;
    ...
    function html($this, content) {
        ...
        if (
            typeof window["regexpMatchFormat_" + $this.attr("id")] !==
                "undefined" &&
            typeof window["regexpReplaceWith_" + $this.attr("id")] !==
                "undefined"
        ) {
    ...
    function stopTimer($this, timerType, opts, func) {
        $("#" + opts.stopButton).click(function () {
            if ($(this).val() != "start") {
                ...
                window["minutes_" + timerType + $this.attr("id")] =
                    opts.minutes;
                window["seconds_" + timerType + $this.attr("id")] =
                    opts.seconds;
                func($this, opts);
