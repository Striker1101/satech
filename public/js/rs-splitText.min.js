 ...
 */ !(function (a, b) {
    ...
    function e(a, d) {
        ...
        return v(a)
            ? a
            : "string" == (c = typeof a) && !d && a
            ? n.call(b.querySelectorAll(a), 0)
            : a && "object" == c && "length" in a
            ? n.call(a, 0)
            : a
            ? [a]
            : [];
    ...
    function h(a, c, d) {
        ...
        if (1 === b || 9 === b || 11 === b)
            ...
            (3 !== b && 4 !== b) ||
                (a.nodeValue = a.nodeValue.split(c).join(d));
    }
    function i(c, a) {
    ...
    function k(c) {
        ...
        for (b = 0; b < f; b++)
            (a = d[b])._isSplit
                ? k(a)
                : b && a.previousSibling && 3 === a.previousSibling.nodeType
                ? ((a.previousSibling.nodeValue +=
                      3 === a.nodeType ? a.nodeValue : a.firstChild.nodeValue),
                  c.removeChild(a))
                : 3 !== a.nodeType &&
                  (c.insertBefore(a.firstChild, a), c.removeChild(a));
    }
    function a(a, b) {
    ...
    function y(d, s, W, U, N, C, A) {
        var e,
            ...
            S = a("fontSize", n) * (s.lineThreshold || 0.2),
            R = n.textAlign,
            E = [],
            L = [],
            M = [],
        ...
        for (e = 0; e < t; e++)
            if (((v = (c = y[e]).parentNode === d), "BR" !== c.nodeName))
                if (
                    ...
                    if (c._isSplit)
                        for (
                            c._next = j = c.nextSibling,
                                c.parentNode.appendChild(c);
                            j && 3 === j.nodeType && " " === j.textContent;
                        ...
                        c.parentNode._isSplit
                            ? ((c._parent = c.parentNode),
                              ...
                              t--)
                            : v ||
                              ((p = !c.nextSibling && l(c.parentNode, d, F)),
        ...
        if (u) {
            ...
            for (
                ...
                for (
                    w = u[e],
                        (f = b.createElement(D)).style.cssText =
                ...
                0 === t
                    ? (f.innerHTML = "&nbsp;")
                    : r || x || (k(f), h(f, String.fromCharCode(160), " ")),
                    o && ((f.style.width = P), (f.style.height = c._h + "px")),
                    d.appendChild(f);
            }
            d.style.cssText = q;
        }
        o &&
            (A > d.clientHeight &&
                ((d.style.height = A - V + "px"),
                d.clientHeight < A && (d.style.height = A + Y + "px")),
            C > d.clientWidth &&
                ((d.style.width = C - T + "px"),
                d.clientWidth < C && (d.style.width = C + X + "px"))),
            H &&
                (O ? (d.style.display = O) : d.style.removeProperty("display")),
            i(W, E),
            r && i(U, L),
            i(N, M);
    }
    function w(i, e, B, o) {
        ...
        for (
            ...
            if (((d = c.charAt(a)), A && (w = A(c.substr(a), e.specialChars))))
                (d = c.substr(a, w || 1)),
                    (f += n && " " !== d ? o() + d + "</" + j + ">" : d),
                    (a += w - 1);
            else if (d === k && c.charAt(a - 1) !== k && a) {
                for (f += p ? z : "", p = 0; c.charAt(a + 1) === k; )
                    (f += l), a++;
                a === v - 1
                    ? (f += l)
                    : ")" !== c.charAt(a + 1) && ((f += l + B()), (p = 1));
            } else
                "{" === d && "{{LT}}" === c.substr(a, 6)
                    ? ((f += n ? o() + "{{LT}}</" + j + ">" : "{{LT}}"),
                      (a += 5))
                    : (55296 <= d.charCodeAt(0) && d.charCodeAt(0) <= 56319) ||
                      (65024 <= c.charCodeAt(a + 1) &&
                          c.charCodeAt(a + 1) <= 65039)
                    ? ((m =
                          ((c.substr(a, 12).split(s) || [])[1] || "").length ||
                          2),
                      (f +=
                          n && " " !== d
                              ? o() + c.substr(a, m) + "</" + j + ">"
    ...
    (t = /(?:\r|\n|\t\t)/g),
        ...
        (n = [].slice),
        (f =
            (((p = d.prototype).split = function (a) {
    ...
    (f.version = "3.6.1"),
        (c.SplitText = f),
        (c.default = f),
        typeof window == "undefined" || window !== c
